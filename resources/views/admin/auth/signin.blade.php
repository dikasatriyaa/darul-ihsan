...
@section('content')
    <div class="relative z-1 bg-white p-6 sm:p-0">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row">
            <!-- Form -->
            <div class="flex w-full flex-1 flex-col lg:w-7/12">
                    ...
                    <div>
                        ...
                        <div>
                            {{-- <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-5">
                                <button
                                    class="inline-flex items-center justify-center gap-3 rounded-lg bg-gray-100 px-7 py-3 text-sm font-normal text-gray-700 transition-colors hover:bg-gray-200 hover:text-gray-800 dark:hover:bg-white/10">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <input type="email" id="email" name="email" placeholder="info@gmail.com"
                                            class=" shadow-theme-xs focus:border-red-300 focus:ring-red-500/10  h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden " />
                                    </div>
                                    <!-- Password -->
                                    <div>
                                        <label class="mb-1.5 block text-sm font-medium text-gray-700">
                                        ...
                                        <div x-data="{ showPassword: false }" class="relative">
                                            <input :type="showPassword ? 'text' : 'password'"
                                                ...
                                                class=" shadow-theme-xs focus:border-red-300 focus:ring-red-500/10  h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pr-11 pl-4 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden "
                                                name="password" />
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <a href="/reset-password" class="text-red-500 hover:text-red-600 text-sm">
                                            Forgot password?
                                        </a>
                                    </div>
                                    <!-- Button -->
                                    <div>
                                        <button
                                            class="bg-red-600 shadow-theme-xs hover:bg-red-500 flex w-full items-center justify-center rounded-lg px-4 py-3 text-sm font-medium text-white transition">
                                            Sign In
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div class="mt-5">
                                <p class="text-center text-sm font-normal text-gray-700 sm:text-start">
                                    ...
                                    <a href="/signup" class="text-red-500 hover:text-red-600">Sign
                                        Up</a>
                                </p>
                            </div>
                        </div>
            ...
            <div class="bg-red-950 relative hidden h-full w-full items-center lg:grid lg:w-5/12 bg-cover bg-center bg-no-repeat"
                style="background-image: url('{{ asset('image/hero-3.png') }}')">
